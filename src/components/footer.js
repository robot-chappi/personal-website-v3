                    ...
                    <div className='col-md-8 wrapper-footer'>
                        <ul className='footer-links-one'>
                            <div className='footer-links-pages'>
                                ...
                                <li className='footer-link-pg'><FontAwesomeIcon icon={faAnglesRight} className="link-icon" /><Link to="/contact/" className="link-text-pg-footer">Contact</Link></li>
                            </div>
                        </ul>
                        <ul className='footer-links-one'>
                            <div  className='footer-links-pages'>
                                <li className='footer-link-pg'><FontAwesomeIcon icon={faAnglesRight} className="link-icon" /><Link to="/projects/" className="link-text-pg-footer">Progects</Link></li>
                                <li className='footer-link-pg'><FontAwesomeIcon icon={faAnglesRight} className="link-icon" /><Link to="/cooperate/" className="link-text-pg-footer">Cooperate</Link></li>
                                <li className='footer-link-pg'><FontAwesomeIcon icon={faAnglesRight} className="link-icon" /><Link to="/support/" className="link-text-pg-footer">Support</Link></li>
                            </div>
                        </ul>
                    </div>
